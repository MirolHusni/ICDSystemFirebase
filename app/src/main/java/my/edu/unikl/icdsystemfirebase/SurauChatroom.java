...
public class SurauChatroom extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.chat_room_surau);
        setTitle("Surau Chatroom");
        ...
        submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mDatabaseReference.child("Chatroom").child("SurauChat").child(String.valueOf(msg.getMessageTime())).setValue(msg);
    ...
    private void displayChatMessage() {
        ...
        adapter = new FirebaseListAdapter<ChatMessage>(this,ChatMessage.class,R.layout.chat_list_item,
                FirebaseDatabase.getInstance().getReference().child("Chatroom").child("SurauChat"))
        {
            @Override
