...
public class Lvl25Chatroom extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mDatabaseReference.child("Chatroom").child("Level25Chat").child(String.valueOf(msg.getMessageTime())).setValue(msg);
    ...
    private void displayChatMessage() {
        ...
        adapter = new FirebaseListAdapter<ChatMessage>(this,ChatMessage.class,R.layout.chat_list_item,
                FirebaseDatabase.getInstance().getReference().child("Chatroom").child("Level25Chat"))
        {
            @Override
